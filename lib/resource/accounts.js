...
const AccountsResource = Resource.subclass('AccountsResource', function(prototype, _, _protected) {
   ...
   * @return {Promise<JSON Object>} accountSummary
   */
   ...
   * @return {Promise<Number>} availableCash
   */
   ...
   * @return {Promise<Array<JSON Object>>} pendingTransfers
   */
   ...
   * @return {Promise<Array<JSON Object>>} myNotes
   */
   ...
   * @return {Promise<Array<JSON Object>>} myDetailedNotes
   */
   ...
   * @return {Promise<Array<JSON Object>>} myPortfolios
   */
   ...
   * @return {Promise<Array<JSON Object>>} cancellationResults
   */
   ...
   * @return {Promise<Date>} estimatedFundsTransferDate - A Date returned
   ...
   *   the new portfolio.
   * @return {Promise<Number>} portfolioId
   */
   ...
   *   for purchase.
   * @return {Promise<Array<JSON Object>>} 
   */
